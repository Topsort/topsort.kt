...
internal class PurchaseEventTest {
    ...
    fun `purchase with all optional fields`() {
        ...
        assertThat(purchase.deviceType).isEqualTo(Device.MOBILE)
        assertThat(purchase.channel).isEqualTo(Channel.ONSITE)
    }
    ...
    fun `fromJsonObject deserializes purchase with all fields`() {
        ...
        assertThat(purchase.deviceType).isEqualTo(Device.MOBILE)
        assertThat(purchase.channel).isEqualTo(Channel.INSTORE)
    }
